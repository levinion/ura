...
pub struct PointerMoveSurfaceGrab<B: Backend + 'static> {
    pub start_data: PointerGrabStartData<State<B>>,
    pub window: WindowElement,
    pub initial_window_location: Point<i32, Logical>,
}

impl<BackendData: Backend> PointerGrab<State<BackendData>> for PointerMoveSurfaceGrab<BackendData> {
    fn motion(
        &mut self,
    ...
    fn start_data(&self) -> &PointerGrabStartData<State<BackendData>> {
        &self.start_data
    }
}

pub struct TouchMoveSurfaceGrab<B: Backend + 'static> {
    pub start_data: TouchGrabStartData<State<B>>,
    pub window: WindowElement,
    pub initial_window_location: Point<i32, Logical>,
}

impl<BackendData: Backend> TouchGrab<State<BackendData>> for TouchMoveSurfaceGrab<BackendData> {
    fn down(
        &mut self,
        _data: &mut State<BackendData>,
        _handle: &mut smithay::input::touch::TouchInnerHandle<'_, State<BackendData>>,
        _focus: Option<(
            <State<BackendData> as smithay::input::SeatHandler>::TouchFocus,
            Point<i32, Logical>,
        )>,
    ...
    fn up(
        &mut self,
        data: &mut State<BackendData>,
        handle: &mut smithay::input::touch::TouchInnerHandle<'_, State<BackendData>>,
    ...
    fn start_data(&self) -> &smithay::input::touch::GrabStartData<State<BackendData>> {
        &self.start_data
    }
}
...
impl<BackendData: Backend> PointerGrab<State<BackendData>>
...
impl<BackendData: Backend> TouchGrab<State<BackendData>> for TouchResizeSurfaceGrab<BackendData> {
    fn down(
        &mut self,
        _data: &mut State<BackendData>,
        _handle: &mut smithay::input::touch::TouchInnerHandle<'_, State<BackendData>>,
